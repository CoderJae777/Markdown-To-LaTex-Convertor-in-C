...
#define TOK_UNDERSCORE 5
#define TOK_DOUBLE_UNDERSCORE 6
#define TOK_TRIPLE_UNDERSCORE 7
#define TOK_BACKTICK 8
#define TOK_DOUBLE_TICK 9
#define TOK_TRIPLE_BACKTICK 10
#define TOK_LBRACKET 11
#define TOK_RBRACKET 12
#define TOK_LPAREN 13
#define TOK_RPAREN 14
#define TOK_BANG 15
#define TOK_DOLLAR 16
#define TOK_DOUBLE_DOL 17
#define TOK_NEWLINE 18
#define TOK_GT 19   /* > for blockquote */
#define TOK_DASH 20 /* - for list */
#define TOK_PIPE 21 /* | for tables */
#define TOK_EOF 22
